...
const AddUserContainer = React.createClass({
 ...
 handleSubmit: function (e) {
    ...
    e.preventDefault();
     const formPayload = {
            ...
            name: this.refs.name,
            github: this.refs.github,
            instagram: this.refs.instagram,
            twitter: this.refs.twitter,
            facebook: this.refs.facebook,
            worksOn: this.refs.worksOn
        };
     userApi.addUser({
         data: {formPayload}
     });
 ...
 _handleTwitter: function (e) {
  ...
  _handleWorksOn: function (e) {
      var state = {};
      this.setState({worksOnk: e.target.value});
  },   
